...
export const CardPointJoinButton = styled.TouchableOpacity`
  ...
  width: ${normalize(61)}px;
  background-color: #0c9d11;
  border-top-right-radius: ${normalize(6)}px;
  border-top-left-radius: ${normalize(6)}px;
  border-bottom-right-radius: ${normalize(6)}px;
  border-bottom-left-radius: ${normalize(6)}px;
`;
